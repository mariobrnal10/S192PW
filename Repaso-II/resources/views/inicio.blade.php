...
<div class="container vh-100 d-flex align-items-center">
  <div class="row w-100">
    ...
    <div class="col-12 text-center  mb-4" style="color: #fff;">
      <h5 class="card-title">{{__('Noticias Del Dia')}}</h5>
    </div>
